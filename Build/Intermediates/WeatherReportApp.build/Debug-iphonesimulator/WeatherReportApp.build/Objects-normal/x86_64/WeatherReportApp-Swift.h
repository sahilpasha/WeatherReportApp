...
SWIFT_CLASS("_TtC16WeatherReportApp11AppDelegate")
...
SWIFT_CLASS("_TtC16WeatherReportApp14ViewController")
@interface ViewController : UIViewController <UIScrollViewDelegate, UITableViewDataSource, CLLocationManagerDelegate, UITableViewDelegate>
...
SWIFT_CLASS("_TtC16WeatherReportApp11weatherCell")
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified typeofWeather;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified highTemp;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified lowTemp;
- (void)awakeFromNib;
